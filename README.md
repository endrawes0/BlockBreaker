...
## Gameplay Loop
1. Choose a room from the map (combat, elite, rest, shop; boss at the end).
2. In combat, play cards to shape the next volley (damage, extra balls, piercing, buffs, etc.).
...
| Piercing Shot | 2 | Offense | Balls pierce bricks this volley. |
...
| Vitality | 2 | Defense | +10 max HP and heal 10. |
